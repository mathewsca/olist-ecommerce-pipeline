...
* **Para qual finalidade o dataset foi criado?**  
  Para servir de base de referência e treinamento no estudo de caso de triagem de riscos em obras e serviços de engenharia no âmbito do projeto {{cookiecutter.project_name}}.
